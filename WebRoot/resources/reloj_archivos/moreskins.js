CoolClock.config.skins = {
	...
	simple/*was gIG3*/: {
		outerBorder:      { lineWidth: 255, radius: 1, color: "#E5ECF9", alpha: 1 },
		smallIndicator:   { lineWidth: 20, startAt: 90, endAt: 94, color: "#369ca9", alpha: 1 },
		largeIndicator:   { lineWidth: 20, startAt: 90, endAt: 94, color: "#369ca9", alpha: 1 },
		hourHand:         { lineWidth: 16, startAt: 0, endAt: 60, color: "#032e33", alpha: 1 },
		minuteHand:       { lineWidth: 16, startAt: 0, endAt: 80, color: "#032e33", alpha: 1 },
		secondHand:       { lineWidth: 10, startAt: 80, endAt: 85, color: "red", alpha: .85 },
		secondDecoration: { lineWidth: 6, startAt: 0, radius: 4, fillColor: "black", color: "black", alpha: 1 }
	},
