...
<body style="overflow: hidden;">
	<form:form name='lugarAtencionForm' action="editarLugarAtencion" method='POST' commandName="lugarAtencionForm" id="lugarAtencionForm">
...
<script type="text/javascript">
	function guardar(){
		$("#lugarAtencionForm").attr("action", "editarLugarAtencion");
	    var array = [];
	    var i = 0;
	    
	    $("#primero option").each(function(){
    		array[i] = $(this).val();
    		i++;
   		});
	    $("#rolesSeleccionadosPrimero").val(array);
	    
	    array = [];
	    i = 0;
	    $("#segundo option").each(function(){
    		array[i] = $(this).val();
    		i++;
   		});	    
	    $("#rolesSeleccionadosSegundo").val(array);		
	...
	function buscar(){
		$("#lugarAtencionForm").attr("action", "buscarLugarAtencion");
		$("#lugarAtencionForm").submit();
	}
	...
	$( document ).ready(function() {
		...
		if (editar == "true") {
			...
			$('#correoLugarAtencion').prop('readonly', false);
		}
