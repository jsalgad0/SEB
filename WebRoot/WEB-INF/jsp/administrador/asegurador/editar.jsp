...
<body style="overflow: hidden;">
	<form:form name='aseguradorForm' action="editarAsegurador" method='POST' commandName="aseguradorForm" id="aseguradorForm">
...
<script type="text/javascript">
	function guardar(){
		$("#aseguradorForm").attr("action", "editarAsegurador");
		$("#aseguradorForm").submit();
	}
	
	function buscar(){
		$("#aseguradorForm").attr("action", "buscarAsegurador");
		$("#aseguradorForm").submit();
	}
