...
<body style="overflow: hidden;">
	<form:form name='prestadorForm' action="eliminarPrestador" method='POST' commandName="prestadorForm" id="prestadorForm">
...
<script type="text/javascript">
	function eliminar(){
		$("#prestadorForm").attr("action", "eliminarPrestador");
		$("#prestadorForm").submit();
	}
	
	function buscar(){
		$("#prestadorForm").attr("action", "buscarPrestadorEliminar");
		$("#prestadorForm").submit();
	}
