...
<script type="text/javascript">
	...
	function consulta(){
		...
		if ($("#noDeSerie").val() == "" || $("#noDeSerie").val() == "Numero de Serie Externo"){
			$.fancybox.open({
				content : "<div id=\"contenedor3_popup\"><div class=\"icon_popup usuario2\"></div><h1>Debe Ingresar CÛdigo Externo</h1><div class=\"btn_popup\"><div class=\"btn_cerrar_popup\" onclick=\"$.fancybox.close();\"></div></div></div>",
				openEffect : 'elastic',
				openSpeed  : 150,
				closeEffect : 'elastic',
				closeSpeed  : 150,								
		...
		if (Params.CSensor != ""){
			...
			$.getJSON("lugarAtencionByCodigo", {busqueda:Params.Ins} ,function(response){ 
				...
				$.fancybox.open({
					content : "<div id=\"contenedor3_popup\"><div class=\"icon_popup usuario2\"></div><h1>Lector ya est· registrado para el Lugar de AtenciÛn "+lugarAtencion+"</h1><div class=\"btn_popup\"><div class=\"btn_cerrar_popup\" onclick=\"$.fancybox.close();\"></div></div></div>",
					openEffect : 'elastic',
					openSpeed  : 150,
					closeEffect : 'elastic',
					closeSpeed  : 150,								
            ...
            $("#noDeSerieInterno").val(Params2.CSensor);
			/* alert("El cÛdigo " +Params2.CodExt+ " no existe en la base, debe ser registrado."); */
		}
	}
