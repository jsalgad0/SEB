...
<div id="admin_contenido2">
  ...
  <div class="linea_corta2">
    ...
    <div class="linea_supervisor margen">
   		<input class="campo_supervisor tam_7" style="margin-right:0px !important;" placeholder="Código *"/><!--
          --><input class="btn_solo buscar_icono" onclick="location.href='#';" />
   		<input class="campo_supervisor tam_18" placeholder="Nombre ó Drescripción *" />
