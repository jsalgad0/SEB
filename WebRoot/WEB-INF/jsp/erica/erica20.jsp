   ...
   <div class="pleca_menu"></div><!--     
     --><div class="pestanias_contenedor">
   			<ul id="pmenu">
   				...
   				<li class="pactiva"><a href="#"><img src="${pageContext.request.contextPath}/resources/img/atn_medica/solicitud_referencia.png" class="icono_pestania"/></a>
   					<ul class="psubmenu">
	...
	<div class="linea_supervisor margen">
   		<textarea class="campo_supervisor tam_23" placeholder="Motivo de la Referencia*"></textarea>
    </div>
    
    <div class="linea_supervisor margen">
   		<select class="selectt campo_supervisor tam_18" name="Unidad">
            	<option>Unidad Médica Receptora*</option>
            	<option>2</option>
                <option>3</option>
    	</select>
    	
    	<select class="selectt campo_supervisor tam_10 margen2" name="Esp">
	...
	<div class="linea_supervisor margen margen_arriba2">
   		<div class="titulo_supervisor gris tam_5">Consulta externa especial*
	    	<input type="checkbox" name="consulta" />
	    </div> 
	    <div class="titulo_supervisor gris tam_4 margen">Hospitalización
	    	<input type="checkbox" name="consulta" />
	    </div>
	   	<div class="titulo_supervisor gris tam_10 margen">Estudios auxiliares de diagnóstico y tratamiento
	    	<input type="checkbox" name="consulta" />
	    </div>	
    </div>
	...
	<div class="linea_supervisor margen">
   		<textarea class="campo_supervisor tam_23" placeholder="Presentación del caso:Motivo del envío, valoración, diagnóstico y terapéutica"></textarea>
    </div>
    
    <div class="linea_supervisor margen">
   		<textarea class="campo_supervisor tam_23" placeholder="Resultados de Laboratorio y Gabinete"></textarea>
    </div>
