...
<div id="contenedor_gral">
	<!-- pre-loader 
	<div id="pre-load"><div id="imagen-load"><img src="${pageContext.request.contextPath}/resources/img/load_flor.gif" alt="" /></div>
	</div>
	-->
<div id="admin_contenido">
	...
	<div class="linea_supervisor margen4">
      ...
      <div class="margen_izq2">
      	<input class="campo_supervisor tam_4" style="margin-right:0px !important;" placeholder="Fecha atención" /><!--
          --><input class="btn_solo buscar_icono" onclick="location.href='#';" />
      </div>	
    </div>
