...
<div id="admin_contenido2">
  ...
  <div class="linea_corta2">
    ...
    <div class="linea_supervisor margen">
   		<input class="campo_supervisor tam_7" placeholder="RFC *" />
    ...
    <div class="linea3 margen10">
			...
			<div class="error tam_6"># externo</div>
			<div class="error tam_6"># interno</div>
	</div>
    ...
    <div class="linea_supervisor margen">
	 ...
	 <div class="linea3 margen">
			<div class="error tam_2"></div>
			<div class="error tam_5"></div>
			<div class="error tam_9"></div>
			<div class="error tam_6 margen5">Se requiere CP</div>
	</div>  
    ...
    <div class="linea3 margen10">
			<div class="error tam_20">Es necesario el nombre</div>
	</div>
    
     <div class="linea_supervisor margen">
   		<input class="campo_supervisor tam_7 margen12" placeholder="Teléfono 1*" />
   		<input class="campo_supervisor tam_7 margen5" placeholder="Teléfono2" />
    </div>
