  ...
  <div class="linea_corta2">
   <div class="pleca_menu"></div><!--     
	...
	<div class="linea_supervisor margen margen_arriba">
		<div class="texto_supervisor5 gris tam_7">M.P.F.: Temporales
			<input class="margen2" type="radio" name="sangre" />
		</div>
	    	
    	<div class="texto_supervisor5 gris tam_4">Ninguno
    		<input class="margen2" type="radio" name="sangre" />
    	</div>
	    	
       <div class="texto_supervisor5 gris tam_4">Definitivos
       		<input class="margen2" type="radio" name="sangre" />
       </div>	    	  
    </div>   		
  
	<div class="linea_supervisor margen margen_arriba">
   		<input class="campo_supervisor tam_2" placeholder="MENARCA"/> 
   		<input class="campo_supervisor tam_2" placeholder="RITMO"/> 
   		<input class="campo_supervisor tam_2" placeholder="VSA"/>   
    </div>
    <div class="linea_pegada margen">
   		<input class="campo_supervisor tam_2" placeholder="FUR"/> 
   		<input class="campo_supervisor tam_2" placeholder="G"/> 
   		<input class="campo_supervisor tam_2" placeholder="P"/>   
    </div>
    <div class="linea_pegada margen">
   		<input class="campo_supervisor tam_2" placeholder="A"/> 
   		<input class="campo_supervisor tam_2" placeholder="C"/>    
    </div>
