    ...
    <div id="admin_contenidoFrame3">
        ...
        --><div class="pestanias_contenedor">
   			<ul id="pmenu">
   				...
   				<li class="pactiva"><a href="#"><img src="${pageContext.request.contextPath}/resources/img/atn_medica/otros_estudios.png" class="icono_pestania"/></a>
   					<ul class="psubmenu">
      ...
      <div class="linea_corta_cont margen5">
       <div class="linea_corta">
		...
		<div class="linea_corta margen_arriba4 margen2">
	    	<input class="campo_supervisor2 tam_10" placeholder="Ingrese Código o descripción" />
	    ...
	    <div class="linea_mini margen2">
	     ...
	     <div class="linea_corta margen2 margen_arriba4">
	     	...
	     	<div class="btn btn_nueva_orden"></div>
