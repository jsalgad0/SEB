...
<div  class="tabla_popup2 margen10">   
  ...
  <div class="tabla_contenedor_popup2 desplazar alto_tabla2">  	
	<div class="tabla_popup2">
          ...
          <div class="fila_popup">
        	<div class="celda_popup texto_popup1 blanco tam_fijo6">Exámen de orina completa
            </div>
            <div class="celda_popup texto_popup1 blanco tam_fijo7">25/03/1980
            </div>
            <div class="celda_popup texto_popup1 blanco tam_fijo9"><input type="checkbox" name="ok">
            </div>
    	 </div> 
    	 
    	 <div class="fila_popup">
        	<div class="celda_popup texto_popup1 blanco tam_fijo6">Química sanguínea
            </div>
            <div class="celda_popup texto_popup1 blanco tam_fijo7">25/03/1980
            </div>
            <div class="celda_popup texto_popup1 blanco tam_fijo9"><input type="checkbox" name="ok">
    	 ...
    	 <div class="fila_popup">
        	<div class="celda_popup texto_popup1 blanco tam_fijo6">EGO
            </div>
            <div class="celda_popup texto_popup1 blanco tam_fijo7">25/03/1980
            </div>
            <div class="celda_popup texto_popup1 blanco tam_fijo9"><input type="checkbox" name="ok">
