   ...
   <div class="pleca_menu"></div><!--     
	...
	<div class="linea_supervisor margen">
   		<div class="texto_supervisor2 verde">
	         COPIA-EMISIÓN DE RECETA MÉDICA
	    </div>
    ...
    <div class="linea_supervisor margen">
            ...
            <input class="campo_supervisor tam_9" placeholder="Nuevo Medicamento" />
    ...
    <div class="linea_supervisor margen">
            ...
            <input class="campo_supervisor tam_9" placeholder="Tempra" />
            <input class="campo_supervisor tam_16 centrado" placeholder="No." />
            <select class="selectt campo_supervisor tam_17" name="Unidad">
            	<option>Unidad</option>
            	<option>Pastilla</option>
    ...
    <div class="linea_supervisor margen">
            ...
            <input class="campo_supervisor tam_9" placeholder="Ribotril" />
            <input class="campo_supervisor tam_16 centrado" placeholder="No." />
            <select class="selectt campo_supervisor tam_17" name="Unidad">
            	<option>Unidad</option>
            	<option>Pastilla</option>
    ...
    <div class="linea_supervisor margen">
            ...
            <input class="campo_supervisor tam_9" placeholder="Ketorolak" />
            <input class="campo_supervisor tam_16 centrado" placeholder="No." />
            <select class="selectt campo_supervisor tam_17" name="Unidad">
            	<option>Unidad</option>
            	<option>Pastilla</option>
    ...
    <div class="linea_corta margen">
   		<div class="linea_corta texto_arriba margen_arriba2 borde2 desplazar tam_14">
