...
<form:form action="guardarAntecedentesFamiliares" method='POST' commandName="antecedentesFamiliaresForm">
<div id="admin_contenido2">

    <form:hidden path="idHistoriaClinica"/>
    <form:hidden path="idAntecedentesFamiliares"/>
  ...
  <div class="linea_corta2">
   <div class="pleca_menu"></div><!--     
     --><div class="pestanias_contenedor">
   			<ul id="pmenu">
   				<li  class="pactiva"><a href="#"><img src="${pageContext.request.contextPath}/resources/img/historia_clinica/ante_familiares.png" class="icono_pestania"/></a>
   					<ul class="psubmenu">
   						<li class="caja_texto pad_text2 texto_pestania">ANTECEDENTES FAMILIARES</li>
   					</ul>
   				</li>
   				
   				<li><a href="javascript:personalesNoPatologicos()"><img src="${pageContext.request.contextPath}/resources/img/historia_clinica/personales_nopat.png" class="icono_pestania"/></a>
   					<ul class="psubmenu">
   						<li class="caja_texto pad_text2 texto_pestania">PERSONALES NO PATOLÓGICOS</li>
   					</ul>
   				</li>
   				
   				<li><a href="javascript:antecedentesPersonales()"><img src="${pageContext.request.contextPath}/resources/img/historia_clinica/ante_personales.png" class="icono_pestania"/></a>
   					<ul class="psubmenu">
...
<script>
	...
	function guardarAntecedentes(){
				var antecedentesFamiliaresForm = $("#antecedentesFamiliaresForm").serialize();
			    $.getJSON("guardarAntecedentesFamiliares", antecedentesFamiliaresForm ,function(response){
			    	if(response.error != undefined && response.error != ""){
		    			...
		    			$.fancybox.open({
							content : "<div id=\"contenedor3_popup\"><div class=\"icon_popup usuario2\"></div><h1> Antecedentes Familiares Guardados exitosamente</h1><div class=\"btn_popup\"><div class=\"btn_cerrar_popup\" onclick=\"$.fancybox.close();\"></div></div></div>",
							openEffect : 'elastic',
							openSpeed  : 150,
							closeEffect : 'elastic',
							closeSpeed  : 150,								
