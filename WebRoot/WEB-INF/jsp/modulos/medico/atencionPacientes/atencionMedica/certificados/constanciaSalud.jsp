  ...
  <div class="linea_corta2">
   <div class="pleca_menu"></div><!--     
    ...
    <div class="linea_supervisor margen margen_arriba2">
           <div class="pestania_certificado btn_certificado1" onclick="javascript:constanciaAsistencia();"></div>
           <div class="pestania_certificado btn_certificado2" onclick="javascript:cuidadosMaternales();"></div>
           <div class="pestania_certificado btn_certificado3_clic" onclick="javascript:constanciaSalud();"></div>
    </div>    	
	
	<div class="linea_90 margen borde1 alto_tabla"> 
    	
	    <div class="linea_supervisor centrado margen_arriba4">
	   		<textarea class="campo_supervisor tam_24b" placeholder="Estado clínico del paciente"></textarea>
	    </div>    	   	    	    	
