...
public class MedicoCuidadosMaternalesController {

	@Autowired
	private HttpSession session;	
	
	@RequestMapping(value = "/inicioCuidadosMaternales")
	public ModelAndView inicioCuidadosMaternales(MedicoAtencionPacientesForm medicoAtencionPacientesForm) {
		//log.info("inicioCuidadosMaternales");	
		ModelAndView model = new ModelAndView("atencionCuidadosMaternales");
